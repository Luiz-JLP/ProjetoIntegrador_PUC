...
namespace PinguinoApp.API.Controllers
{
    ...
    public class EnderecosController : Controller
    {
        ...
        [HttpPost("one")]
        public async Task<ActionResult<dynamic>> Insert([FromBody] Endereco entity)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<ActionResult<dynamic>> Insert([FromBody] IEnumerable<Endereco> entities)
        {
            try
            {
        ...
        [HttpPut]
        public async Task<ActionResult<dynamic>> Update([FromBody] Endereco entity)
        {
            try
            {
