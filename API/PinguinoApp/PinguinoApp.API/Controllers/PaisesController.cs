...
namespace PinguinoApp.API.Controllers
{
    ...
    public class PaisesController : Controller
    {
        ...
        [HttpPost("one")]
        public async Task<ActionResult<dynamic>> Insert([FromBody] Pais entity)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<ActionResult<dynamic>> Insert([FromBody] IEnumerable<Pais> entities)
        {
            try
            {
        ...
        [HttpPut]
        public async Task<ActionResult<dynamic>> Update([FromBody] Pais entity)
        {
            try
            {
