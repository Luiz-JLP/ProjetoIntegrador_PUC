...
namespace PinguinoApp.API.Controllers
{
    ...
    public class ProdutosController : Controller
    {
        ...
        [HttpPost("one")]
        public async Task<ActionResult<dynamic>> Insert([FromBody] Produto entity)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<ActionResult<dynamic>> Insert([FromBody] IEnumerable<Produto> entities)
        {
            try
            {
        ...
        [HttpPut]
        public async Task<ActionResult<dynamic>> Update([FromBody] Produto entity)
        {
            try
            {
