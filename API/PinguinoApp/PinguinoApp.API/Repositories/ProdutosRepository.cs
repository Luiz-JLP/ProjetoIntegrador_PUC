...
namespace PinguinoApp.API.Repositories
{
    public class ProdutosRepository : IRepository<Produto>
    {
        ...
        {
            string command = $"SELECT id, nome, sku, codigobarras, fonecedor_id, descricao, precovenda, ativo FROM {tabela};";
        ...
        public async Task<bool> Insert(Produto entity)
        {
            ...
            return await service.ScalarAsync<bool>(command, parameters:
                                                    new
                                                    {
                                                        @nome = entity.Nome,
                                                        @sku = entity.Sku,
